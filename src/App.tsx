                    ...
                    <div className='projects-section__container'>
                        <div className='projects-section__intro'>
                            ...
                            <h2 className='projects-section__title'>
                                Public builds and engineering notes
                            </h2>
                        </div>
                ...
                <section id='tech-stack' className='tech-stack-section'>
                    <div className='tech-stack-section__container'>
                        <div className='tech-stack-section__intro'>
                            <p className='tech-stack-section__eyebrow'>
                                Capabilities
                            </p>
                            <h2 className='tech-stack-section__title'>
                                Systems view of the stack
                            </h2>
                        </div>
                                ...
                                >
                                    ...
                                    <div className='capability-card__items'>
                                        {group.items.map((item) => (
                                            <span
                                                key={item}
                                                className='capability-card__item'
                                            >
                                                {item}
                                            </span>
                                        ))}
                    ...
                    <div className='about-section__container'>
                        <div className='about-section__intro'>
                            ...
                            <h2 className='about-section__title'>
                                I like building systems that feel clear on the
                                surface and disciplined underneath
                            </h2>
                            <p className='about-section__summary'>
                                Interfaces, services, tests, cloud workflows,
                                and the small decisions that keep products
                                maintainable. Started from Mechatronics
                                Engineering, moved through frontend, backend,
                                cloud, and distributed systems. Currently
                                working on audio platforms, AI validation, fraud
                                detection, and secure cloud infrastructure.
                            </p>
                        </div>
                    ...
                    <div className='contact-section__container'>
                        <div className='contact-section__intro'>
                            ...
                            <p className='contact-section__summary'>
                                If my experience in frontend systems, backend
                                services, cloud platforms, or AI workflows fits
                                what you're building, I'd be happy to connect.
                            </p>
                        </div>
